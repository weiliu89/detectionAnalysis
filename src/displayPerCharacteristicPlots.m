function displayPerCharacteristicPlots(results_all, titlename)

close all

drawline = true;
makeMultiCategoryPlot(1, results_all, 'occ', [titlename ': Occlusion'], 1, {'N', 'L', 'M', 'H'}, drawline);
