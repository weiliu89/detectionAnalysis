...
\begin{center}
\begin{tabular}{c c c}
\includegraphics[width=0.3\textwidth]{../plots_fp_pie_animals.pdf} &
\includegraphics[width=0.3\textwidth]{../plots_fp_pie_vehicles.pdf} &
\includegraphics[width=0.3\textwidth]{../plots_fp_pie_furniture.pdf} \\
\includegraphics[width=0.3\textwidth]{../plots_fp_animals.pdf} &
\includegraphics[width=0.3\textwidth]{../plots_fp_vehicles.pdf} &
\includegraphics[width=0.3\textwidth]{../plots_fp_furniture.pdf} \\
\includegraphics[width=0.3\textwidth]{../plots_fp_dttrendarea_animals.pdf} & \includegraphics[width=0.3\textwidth]{../plots_fp_dttrendarea_vehicles.pdf} &
\includegraphics[width=0.3\textwidth]{../plots_fp_dttrendarea_furniture.pdf} \\
\includegraphics[width=0.3\textwidth]{../plots_fp_trendarea_animals.pdf} &
\includegraphics[width=0.3\textwidth]{../plots_fp_trendarea_vehicles.pdf} &
\includegraphics[width=0.3\textwidth]{../plots_fp_trendarea_furniture.pdf} \\
\hspace{-0.17in}
\vspace{-0.3in}
\end{tabular}
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics[width=\textwidth]{../plots_area_strong.pdf} \\
\includegraphics[width=\textwidth]{../plots_height_strong.pdf} \\
\includegraphics[width=\textwidth]{../plots_aspect_strong.pdf} \\
\end{center}
\caption{
...
\begin{figure}
\begin{center}
\includegraphics[width=0.8\textwidth]{../plots_occlusion_strong.pdf} \\
\includegraphics[width=0.8\textwidth]{../plots_parts_strong.pdf} \\
\includegraphics[width=0.8\textwidth]{../plots_truncation_strong.pdf} \\
\includegraphics[width=0.8\textwidth]{../plots_view_strong.pdf} \\
\end{center}
\caption{
\textbf{Summary of Sensitivity and Impact of Object Characteristics: } We show the \apn performance of the highest performing and lowest performing subsets within each characteristic (occlusion, truncation, bounding box area, aspect ratio, viewpoint, part visibility).  Overall \apn is indicated by the black dashed line.  The difference between max and min indicates sensitivity; the difference between max and overall indicates the impact.
}
